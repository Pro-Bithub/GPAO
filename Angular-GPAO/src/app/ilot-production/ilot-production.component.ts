...
@Component({
  selector: 'app-ilot-production',
  templateUrl: './ilot-production.component.html',
  styleUrls: ['./ilot-production.component.css']
})
export class IlotProductionComponent implements OnInit {
